...
class DoctrineExtension extends AbstractDoctrineExtension
{
    ...
    protected function dbalLoad(array $config, ContainerBuilder $container)
    {
        ...
        $container->setAlias(
            ...
            new Alias(sprintf('doctrine.dbal.%s_connection.event_manager', $this->defaultConnection), false)
        );
    ...
    protected function loadDbalConnection($name, array $connection, ContainerBuilder $container)
    {
        ...
        $def = $container->setDefinition(
            ...
            new DefinitionDecorator('doctrine.dbal.connection.event_manager')
        );
        ...
        $container
            ->setDefinition(
                sprintf('doctrine.dbal.%s_connection', $name),
    ...
    protected function ormLoad(array $config, ContainerBuilder $container)
    {
        ...
        $container->setAlias(
            ...
            sprintf('doctrine.orm.%s_entity_manager', $config['default_entity_manager'])
        );
    ...
    protected function loadOrmEntityManager(array $entityManager, ContainerBuilder $container)
    {
        ...
        $ormConfigDef = $container->setDefinition(
            sprintf('doctrine.orm.%s_configuration', $entityManager['name']),
        ...
        $managerConfiguratorDef = $container
            ->setDefinition(
                ...
                new DefinitionDecorator('doctrine.orm.manager_configurator.abstract')
            )
