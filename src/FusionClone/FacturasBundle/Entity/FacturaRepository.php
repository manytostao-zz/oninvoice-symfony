...
class FacturaRepository extends EntityRepository
{
    public function findByStatus($status)
    {
        ...
        $consulta = $em->createQuery(
            'SELECT ne FROM FacturasBundle:Factura ne WHERE ne.estado = :status ORDER BY ne.fechaVenc'
        );
    ...
    public function findByFacClieStat($codigo, $cliente, $status)
    {

        $em = $this->getEntityManager();
        $consulta = $em->createQuery(
            'SELECT ne FROM FacturasBundle:Factura ne
    ...
    public function findByFacStat($codigo, $status)
    {
    ...
    public function findByFacClie($codigo, $cliente)
    {
    ...
    public function findByFac($codigo)
    {

        $em = $this->getEntityManager();
        $consulta = $em->createQuery(
            'SELECT ne FROM FacturasBundle:Factura ne WHERE ne.codigo LIKE :codigo ORDER BY ne.fechaVenc'
        );
    ...
    public function ajaxTable(array $get, array $filters, $flag = false)
    {
        ...
        $alias = 'r';
        /* DB table to use */
        $tableObjectName = 'FacturasBundle:Factura';
        /**
         * Set to default
         */
    ...
    public function getCount()
    {
        $query = $this->getEntityManager()
            ->getRepository('FacturasBundle:Factura')
