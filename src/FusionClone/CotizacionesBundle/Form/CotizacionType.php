...
class CotizacionType extends AbstractType
{
    ...
    private $itemTypeOptions;

    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder->setAttribute('id', 'formCot')
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(
            array(
                'data_class' => 'FusionClone\CotizacionesBundle\Entity\Cotizacion'
            )
        );
    }
    ...
    /**
     * @param mixed $itemTypeOptions
     */
    public function setItemTypeOptions($itemTypeOptions)
    {
