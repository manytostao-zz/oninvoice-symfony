...
$pagosTable.postDraw = function () {
    var $tr = $('#pagosTable').find('tbody tr');
    $tr.each(function () {
        var aData = $('#pagosTable').dataTable().fnGetData(this);
        var $column = $('<td></td>');
        ...
        $btnEditar.click(function () {
            document.location = Routing.generate('pagos_edit', {'id': $(this).data('id')});
        });

        //Delete
        $btnEliminar.click(function () {
            var id = $(this).attr('data-id');
            $('#deleteButton').attr('href', Routing.generate('pagos_delete', {id: id}));
