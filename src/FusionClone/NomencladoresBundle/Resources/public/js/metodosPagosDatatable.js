 ...
 *
 * */
var $metodosPagosTable = {};


$metodosPagosTable.postDraw = function () {
    var $tr = $('#metodosPagosTable').find('tbody tr');
    $tr.each(function () {
        var aData = $('#metodosPagosTable').dataTable().fnGetData(this);
        var $column = $('<td></td>');
        ...
        $btnEditar.click(function () {
            document.location = Routing.generate('nomencladores_editPagos', {'id': $(this).data('id')});
        });

        //Delete
        $btnEliminar.click(function () {
            var id = $(this).attr('data-id');
            $('#deleteButton').attr('href', Routing.generate('nomencladores_deletePagos', {id: id}));
