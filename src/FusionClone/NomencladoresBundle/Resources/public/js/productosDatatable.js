...
$productosTable.postDraw = function () {
    var $tr = $('#productosTable').find('tbody tr');
    $tr.each(function () {
        var aData = $('#productosTable').dataTable().fnGetData(this);
        var $column = $('<td></td>');
        ...
        $btnEditar.click(function () {
            document.location = Routing.generate('nomencladores_editProd', {'id': $(this).data('id')});
        });

        //Delete
        $btnEliminar.click(function () {
            var id = $(this).attr('data-id');
            $('#deleteButton').attr('href', Routing.generate('nomencladores_deleteProd', {id: id}));
