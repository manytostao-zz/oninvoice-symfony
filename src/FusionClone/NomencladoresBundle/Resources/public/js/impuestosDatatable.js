...
$impuestosTable.postDraw = function () {
    var $tr = $('#impuestosTable').find('tbody tr');
    $tr.each(function () {
        var aData = $('#impuestosTable').dataTable().fnGetData(this);
        var $column = $('<td></td>');
        ...
        $btnEditar.click(function () {
            document.location = Routing.generate('nomencladores_editImp', {'id': $(this).data('id')});
        });

        //Delete
        $btnEliminar.click(function () {
            var id = $(this).attr('data-id');
            $('#deleteButton').attr('href', Routing.generate('nomencladores_deleteImp', {id: id}));
