...
class NomPagosRepository extends EntityRepository
{
    public function findByName($nombre)
    {
        if (!is_null($nombre)) {
            ...
            $consulta = $em->createQuery(
                'SELECT ne FROM NomencladoresBundle:NomPagos ne
                    WHERE ne.nombre LIKE :nombre'
            );
    ...
    public function ajaxTable(array $get, array $filters, $flag = false)
    {
        ...
        $alias = 'p';
        /* DB table to use */
        $tableObjectName = 'NomencladoresBundle:NomPagos';
        /**
         * Set to default
         */
    ...
    public function getCount()
    {
        $query = $this->getEntityManager()
            ->getRepository('NomencladoresBundle:NomPagos')
