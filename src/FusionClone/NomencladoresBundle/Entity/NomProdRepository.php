...
class NomProdRepository extends EntityRepository
{
    public function findByName($nombre)
    {
        if (!is_null($nombre)){
            ...
            $consulta = $em->createQuery(
                'SELECT ne FROM NomencladoresBundle:NomProd ne
    ...
    public function ajaxTable(array $get, array $filters, $flag = false)
    {
        ...
        $alias = 'p';
        /* DB table to use */
        $tableObjectName = 'NomencladoresBundle:NomProd';
        /**
         * Set to default
         */
    ...
    public function getCount()
    {
        $query = $this->getEntityManager()
            ->getRepository('NomencladoresBundle:NomProd')
