...
class NomProdType extends AbstractType
{
    private $action;
    private $id;
    private $tipoForm;
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder->setAttribute('id', 'formCliente')
            ...
            ->add('precio', 'number', array('invalid_message' => 'El precio debe ser un número válido', 'attr' => array('class' => 'form-control')))
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(
            array(
                'data_class' => 'FusionClone\NomencladoresBundle\Entity\NomProd'
            )
        );
    }
